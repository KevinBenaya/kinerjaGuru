                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=beasiswa">Data Penilaian</a></li>
                            <li class="divider"></li>
                            <li><a href="?page=mahasiswa">Data Guru</a></li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=lap_seluruh">Seluruh Guru</a></li>
                            <li><a href="?page=lap_permahasiswa">Per Guru</a></li>
